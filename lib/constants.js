...
export const MARKETING_TYPES = [
    { value: 'deportivo', label: 'Club Deportivo / Baloncesto' },
    { value: 'agropecuario', label: 'Marketing Agropecuario' },
...
export const PLAN_OPTIONS = [
    { 
        value: 'Presencia', 
        label: 'Nivel Presencia', 
        price: 300, 
        deliverables: { videos: 3, posts: 6, strategy: 1, cm: 1 } 
    },
    { 
        value: 'Crecimiento', 
        label: 'Nivel Crecimiento', 
        price: 500, 
        deliverables: { videos: 5, posts: 8, strategy: 1, cm: 1 } 
    },
    { 
        value: 'Autoridad', 
        label: 'Nivel Autoridad', 
        price: 700, 
        deliverables: { videos: 7, posts: 11, strategy: 1, cm: 1 } 
    },
    { 
        value: 'Control', 
        label: 'Nivel Control', 
        price: 999, 
        deliverables: { videos: 10, posts: 16, strategy: 1, cm: 1 } 
    },
    {
        value: 'Solo App',
        label: 'Solo Uso de App',
        price: 70,
        deliverables: { software: true }
    },
    {
        value: 'Proyecto',
        label: 'Proyecto Único / Landing',
        price: 0,
        deliverables: { custom: true }
    },
    {
        value: 'Custom',
        label: 'Plan Personalizado (Servicios)',
        price: 0,
        deliverables: { custom: true }
    }
];
...
export const EDUCATION_SPECIALTIES = [
    { value: 'cursos_agro', label: 'Cursos Agropecuarios' },
    { value: 'manejo_bovino', label: 'Manejo Bovino (Ganado)' },
    { value: 'manejo_porcino', label: 'Manejo Porcino (Cerdos)' },
    { value: 'nutricion_agro', label: 'Nutrición Animal / Agro' },
    { value: 'gestion_fincas', label: 'Gestión de Fincas / Adm.' },
    { value: 'otra_edu', label: 'Otra Rama Educativa' }
];

export const SPORTS_SPECIALTIES = [
    { value: 'baloncesto', label: '🏀 Baloncesto / Basket Profesional' },
    { value: 'futbol', label: '⚽ Fútbol / Clubes & Formativas' },
    { value: 'padel_tenis', label: '🎾 Pádel & Tenis / Torneos' },
    { value: 'crossfit_gym', label: '🏋️‍♂️ CrossFit & Gimnasios' },
    { value: 'voleibol', label: '🏐 Voleibol & Sala' },
    { value: 'boxeo_mma', label: '🥊 Boxeo / MMA & Combate' },
    { value: 'running_ciclismo', label: '🏃‍♂️ Running & Ciclismo' },
    { value: 'polideportivo', label: '🏆 Club Polideportivo Multidisciplinario' }
];

export const INDUSTRY_OPTIONS = [
    { value: 'deportivo', label: 'Club Deportivo / Baloncesto' },
    { value: 'agropecuario', label: 'Agropecuario / Ganadero' },
    { value: 'educativo', label: 'Capacitaciones / Cursos' },
    { value: 'medico', label: 'Salud / Médico' },
    { value: 'hospital', label: 'Sistema de Marketing / Hospitales' },
    { value: 'hospitality', label: 'Gastronomía / Restaurantes' },
