                ...
                {activeModal && (
                    <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center p-0 md:p-8">
                        ...
                        >
                            ...
                            {/* --- FINAL NET AUDIT (PREMIUM REDESIGN) --- */}
                            {activeModal === 'final' && (
                                <div className="space-y-12">
                                    {/* Header Section */}
                                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/5 pb-10">
                                        <div className="space-y-2">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <h4 className="text-5xl font-black uppercase italic tracking-tighter text-white">Análisis de Utilidad</h4>
                                            </div>
                                        ...
                                        <div className="lg:col-span-2 flex flex-col items-center justify-center space-y-10 py-6">
                                            <div className="relative w-72 h-72">
                                                ...
                                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                                    ...
                                                    <p className={`text-6xl font-black italic tracking-tighter ${netProfit > 0 ? 'text-emerald-400' : 'text-rose-500'}`}>
                                        ...
                                        <div className="lg:col-span-3 space-y-4">
                                            ...
                                            >
                                                ...
                                                <div className="relative z-10">
                                                    <h3 className="text-3xl font-black italic text-white uppercase tracking-tight mb-2">Utilidad Operativa</h3>
                                                ...
                                                <div className="relative z-10 text-center md:text-right">
                                                    <span className={`text-7xl font-black italic tracking-tighter drop-shadow-glow leading-none ${netProfit > 0 ? 'text-emerald-400' : 'text-rose-500'}`}>
                                                        ${netProfit?.toLocaleString()}
                                                    </span>
                                                    <div className="flex items-center justify-center md:justify-end gap-2 mt-4">
                                                        <span className={`text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full border ${netProfit > 0 ? 'border-emerald-500/30 text-emerald-400 bg-emerald-500/5' : 'border-rose-500/30 text-rose-500 bg-rose-500/5'}`}>
...
function CalculationRow({ label, value, type, icon: Icon, description, delay = 0 }) {
    ...
    return (
        <motion.div 
            ...
            className="flex justify-between items-center group py-6 px-10 rounded-3xl bg-white/[0.02] hover:bg-white/[0.05] border border-white/5 hover:border-white/10 transition-all duration-300"
        >
            <div className="flex items-center gap-6">
                 ...
                 <div>
                      <p className="text-[10px] font-black text-gray-500 uppercase italic tracking-widest mb-1">{label}</p>
                      <p className="text-[9px] font-bold text-gray-700 uppercase tracking-[0.2em] leading-none">{description}</p>
                 </div>
            </div>
            <div className="text-right">
                 <span className={`text-3xl font-black italic tracking-tighter pr-2 ${isIncome ? 'text-emerald-400' : 'text-white/90'}`}>
                     {value}
                 </span>
            </div>
        </motion.div>
...
function DistributionTag({ label, color, active }) {
    ...
    return (
        <div className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border text-[9px] font-black uppercase tracking-widest transition-all ${
            active ? colorMap[color] : 'text-gray-700 border-white/5 opacity-50'
        }`}>
            <div className={`w-1.5 h-1.5 rounded-full ${active ? colorMap[color].split(' ')[2].replace('bg', 'bg') : 'bg-gray-800'}`} 
