...
import { ChevronRight, ChevronLeft, Layout, Target, Network, Search } from 'lucide-react';
    ...
    return (
        <div className="space-y-12">
            ...
            <div className="relative max-w-2xl mx-auto mb-16 px-4">
                ...
                <motion.div 
                    initial={{ width: '0%' }}
                    animate={{ width: layer === 1 ? '0%' : layer === 2 ? '50%' : '100%' }}
                    ...
                    {layer === 1 && (
                        <div className="space-y-8">
                            ...
                            <div className="flex justify-end pt-8">
                                ...
                                >
                                    Siguiente: Perfil <ChevronRight className="w-5 h-5" />
                                </button>
                            </div>
                        </div>
                    )}
                    {layer === 2 && (
                        <div className="space-y-8">
                            ...
                            <div className="flex justify-between pt-8">
                                ...
                                >
                                    <ChevronLeft className="w-5 h-5" /> Volver a Búsqueda
                                </button>
                                <button 
                                    onClick={() => setLayer(3)}
                                    className="px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white font-black uppercase tracking-widest rounded-2xl flex items-center gap-3 shadow-lg shadow-indigo-600/20 transition-all active:scale-95"
                    ...
                    {layer === 3 && (
                        <div className="space-y-8">
                            ...
                            <div className="flex justify-between pt-8">
                                ...
                                >
                                    Ver Mi Evolución <Layout className="w-5 h-5" />
                                </button>
                            </div>
                        </div>
                    )}
