        ...
        const fetchSyncData = async () => {
            ...
            try {
                ...
                setProfileData({
                    ...
                    drive_root_link: profile?.drive_root_link || clientRecord?.drive_root_link || clientRecord?.onboarding_data?.drive_root_link || (clientRecord?.google_drive_folder_id ? `https://drive.google.com/drive/folders/${clientRecord.google_drive_folder_id}` : '') || (clientRecord?.onboarding_data?.google_drive_folder_id ? `https://drive.google.com/drive/folders/${clientRecord.onboarding_data.google_drive_folder_id}` : '') || '',
                    drive_root_id: profile?.drive_root_id || clientRecord?.google_drive_folder_id || clientRecord?.drive_root_id || clientRecord?.onboarding_data?.drive_root_id || clientRecord?.onboarding_data?.google_drive_folder_id || '',
