...
export const DEPARTMENTS = [
    {
        ...
        icon: Users,
        href: '/dashboard/creative-zone/community',
        color: 'text-blue-400',
        bg: 'bg-blue-500/10',
    ...
    },
    {
        ...
        icon: ImageIcon,
        href: '/dashboard/creative-zone/design',
    ...
    },
    {
        ...
        icon: Mic,
        href: '/dashboard/creative-zone/audio',
    ...
    },
    {
        ...
        icon: UploadCloud,
        href: '/dashboard/creative-zone/editing',
    ...
    },
    {
        ...
        icon: Camera,
        href: '/dashboard/creative-zone/photo',
        color: 'text-pink-400',
        bg: 'bg-pink-500/10',
    ...
    },
    {
        ...
        icon: Clapperboard,
        href: '/dashboard/creative-zone/filmmaker',
        color: 'text-red-400',
        bg: 'bg-red-500/10',
    ...
    },
    {
        ...
        icon: Star,
        href: '/dashboard/creative-zone/talent',
        color: 'text-rose-400',
        bg: 'bg-rose-500/10',
...

    {
        ...
        icon: Globe,
        href: '/dashboard/creative-zone/web',
        color: 'text-cyan-400',
        bg: 'bg-cyan-500/10',
    ...
    },
    {
        ...
        icon: Printer,
        href: '/dashboard/creative-zone/print',
    ...
    },
    {
        ...
        icon: Calendar,
        href: '/dashboard/creative-zone/events',
        color: 'text-lime-400',
        bg: 'bg-lime-500/10',
